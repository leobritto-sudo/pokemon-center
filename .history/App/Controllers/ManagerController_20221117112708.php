...
class ManagerController extends Action {
    ...
    public function editProduct() {
        ...
        $categ = Container::getModel("Produto");

        $categ->__set("id_prod", $_POST["id"]);
        $categ->__set("nome", $_POST["nome"]);
        $categ->__set("preco", $_POST["preco"]);
        $categ->__set("estoque", $_POST["estoque"]);
        $categ->__set("id_categ", $_POST["categ"]);
        $categ->edit();
