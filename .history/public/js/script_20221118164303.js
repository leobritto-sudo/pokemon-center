...
$('#add').on('click', function (e) {
    ...
    var product_name = $('#products option:selected .name_product').text();
    var product_price = $('#products option:selected .price').text();
    ...
    if (product == "") {
        ...
        var text_name = document.createTextNode("Batata")
        var text_price = document.createTextNode("1.00")
